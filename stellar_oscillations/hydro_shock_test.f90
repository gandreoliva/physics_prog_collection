!!! Hydro shock test - 1D hydro+gravity code
...
!!! This program tests the hydro solver with a shock propagation problem
!!! ignoring gravity and with an isothermal equation of state (=> not the Sod shocktube!).
!!! The solution can then be compared with another hydro code, for example, PLUTO.
...
program shock_tube
  ...
  print*, "--------------------------------------------------------------------------"
  print*, " Hydro shock test   *  . ·           > 1D hydro+gravity code"
  print*, "=========================================================================="

  !! Parameters
  rmax = 30d0
  rmin = 0d0
  !! p = k_gas*rh**(1 + 1/n_gas) ==> p = cs^2 * rho  for isothermal case (n_gas large)
  n_gas = 1000d0
  k_gas = 1d0
